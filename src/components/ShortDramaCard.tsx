    ...
    <div className={`group relative ${className} transition-all duration-300 ease-in-out hover:scale-[1.05] hover:z-[500] hover:drop-shadow-2xl`}>
      ...
      >
        ...
        <div className="relative aspect-[2/3] w-full overflow-hidden rounded-lg bg-gray-200 dark:bg-gray-800">
          ...
          {/* 集数标识 */}
          <div className="absolute top-2 left-2 rounded-md bg-black/70 dark:bg-white/20 px-2.5 py-1 text-[10px] sm:text-[11px] font-semibold text-white dark:text-gray-900 shadow-lg border border-white/10 dark:border-black/10 backdrop-blur-sm transition-all duration-300 group-hover:scale-110">
