        ...
        <div className='relative flex items-center gap-1'>
          ...
          {loadMeta && (
            <button
              ...
              className={`p-2 hover:bg-white/10 rounded-xl transition-all duration-200 group active:scale-95 ${showLoadMeta ? 'bg-white/10' : ''
                }`}
              style={{
            ...
            >
              <Info
                className={`w-4 h-4 transition-colors ${showLoadMeta ? 'text-green-400' : 'text-gray-400 group-hover:text-gray-200'
                  }`}
              />
            </button>
          )}
          ...
          {onReload && (
            ...
            >
              <RefreshCw
                className={`w-4 h-4 text-gray-400 transition-all duration-300 ${loading || isReloading
        ...
        >
          <div className='space-y-2 text-xs'>
            <div className='flex items-center justify-between'>
              ...
              <span className={`font-medium ${loadMeta.source === 'cache' ? 'text-blue-400' :
