      ...
      <div className='px-5 py-4 space-y-4 overflow-hidden'>
        ...
        <div className='flex items-center justify-between py-1'>
          ...
          <button
            ...
            className={`relative inline-flex h-6 w-11 items-center rounded-full transition-all duration-300 ${webGPUSupported ? 'active:scale-90' : 'opacity-50 cursor-not-allowed'
              }`}
            style={{
