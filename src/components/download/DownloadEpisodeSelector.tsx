              ...
              {(() => {
                ...
                return (
                  <button
                    ...
                    className={`min-h-[40px] sm:min-h-[44px] min-w-[40px] sm:min-w-[44px] px-2 sm:px-3 py-2 flex items-center justify-center text-xs sm:text-sm font-medium rounded-md transition-all duration-200 whitespace-nowrap font-mono relative active:scale-95
                      ${isSelected
