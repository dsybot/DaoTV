      ...
      >
        ...
        >
          ...
          {config.showRating && rate && (() => {
            ...
            return (
              <div
                className={`absolute top-0 right-0 z-30 ${badgeStyle.bgColor} ${badgeStyle.ringColor} ${badgeStyle.shadowColor} ${badgeStyle.textColor} ${badgeStyle.glowClass} text-[10px] sm:text-xs font-bold rounded-md px-4 sm:px-5 py-0.5 sm:py-1 flex items-center justify-center gap-0.5 sm:gap-1 transition-all duration-300 ease-out group-hover:scale-105 origin-top-right rotate-45`}
                style={{
                  WebkitUserSelect: 'none',
                  userSelect: 'none',
                  WebkitTouchCallout: 'none',
